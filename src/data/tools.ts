...
export const tools: Tool[] = [
  ...
  },
  {
    id: 'redpanda',
    name: 'Redpanda',
    description: 'Kafka-compatible streaming data platform with 10x faster performance',
    longDescription: 'Redpanda is a streaming data platform designed from the ground up in C++ to be lighter, faster, and simpler than Apache Kafka. It eliminates ZooKeeper and JVM dependencies, reducing operational complexity. BYOC deployment allows fully managed clusters in your VPC.',
    homepage: 'https://www.redpanda.com',
    github: 'https://github.com/redpanda-data/redpanda',
    docs: 'https://docs.redpanda.com',
    category: 'databases',
    tags: ['kafka', 'streaming', 'event-streaming', 'message-queue', 'real-time'],
    license: 'hybrid',
    language: 'C++',
    cloudSupport: ['aws', 'gcp', 'azure'],
    stars: 11400,
  ...
  },
  {
    id: 'aiven',
    name: 'Aiven',
    description: 'Managed open source data services for PostgreSQL, Kafka, OpenSearch, and more',
    longDescription: 'Aiven provides fully managed open source data services including PostgreSQL, Apache Kafka, OpenSearch, and ClickHouse across multiple clouds. BYOC allows you to run Aiven services in your own cloud account while Aiven handles provisioning, upgrades, and operations.',
    homepage: 'https://aiven.io',
    docs: 'https://aiven.io/docs/platform/concepts/byoc',
    category: 'databases',
    tags: ['postgresql', 'kafka', 'opensearch', 'clickhouse', 'managed-services', 'multi-cloud'],
    license: 'hybrid',
    language: 'Go',
    cloudSupport: ['aws', 'gcp', 'azure'],
  },
  {
    id: 'warpstream',
    name: 'WarpStream',
    description: 'Kafka-compatible streaming on object storage with zero-disk architecture',
    longDescription: 'WarpStream is a Kafka-compatible data streaming platform built directly on object storage with a zero-disk architecture, reducing costs by 80% or more. Acquired by Confluent in 2024, data never leaves your cloud environment.',
    homepage: 'https://www.warpstream.com',
    docs: 'https://docs.warpstream.com',
    category: 'databases',
    tags: ['kafka', 'streaming', 'object-storage', 's3', 'confluent'],
    license: 'commercial',
    language: 'Go',
    cloudSupport: ['aws', 'gcp', 'azure', 'any'],
  },
  {
    id: 'cockroachdb',
    name: 'CockroachDB',
    ...
    category: 'databases',
    tags: ['distributed-database', 'sql', 'postgresql', 'multi-cloud', 'resilient'],
    license: 'hybrid',
    language: 'Go',
    cloudSupport: ['aws', 'gcp', 'azure'],
    stars: 31600,
  ...
  },
  {
    ...
    category: 'databases',
    tags: ['distributed-database', 'real-time-analytics', 'sql', 'htap', 'mysql-compatible'],
    license: 'hybrid',
    language: 'C++',
    cloudSupport: ['aws'],
  },
  {
    ...
    description: 'Fully managed data integration service built on Apache NiFi',
    longDescription: 'Snowflake Openflow is a Snowflake-managed data integration service that connects any source or destination via hundreds of NiFi-style processors. Supports BYOC deployments running in your AWS VPC for complete control over sensitive data preprocessing.',
    homepage: 'https://www.snowflake.com/en/product/features/openflow',
    docs: 'https://docs.snowflake.com/en/user-guide/data-integration/openflow/about',
    category: 'databases',
    tags: ['etl', 'data-integration', 'apache-nifi', 'data-pipeline', 'snowflake'],
    license: 'commercial',
    cloudSupport: ['aws', 'azure'],
  },
  {
    id: 'estuary',
    name: 'Estuary Flow',
    ...
    category: 'databases',
    tags: ['etl', 'cdc', 'real-time', 'data-pipeline', 'streaming', 'batch-processing'],
    license: 'hybrid',
    language: 'Rust',
    cloudSupport: ['aws', 'gcp', 'azure'],
    stars: 854,
  ...
  },
  {
    id: 'groundcover',
    name: 'Groundcover',
    description: 'eBPF-powered Kubernetes observability with BYOC architecture',
    longDescription: 'Groundcover is a cloud-native observability solution built on eBPF that runs entirely in your Kubernetes clusters. With its inCloud BYOC architecture, all data remains within your VPC with predictable node-based pricing.',
    homepage: 'https://www.groundcover.com',
    docs: 'https://docs.groundcover.com',
    category: 'monitoring',
    tags: ['observability', 'kubernetes', 'ebpf', 'monitoring', 'apm', 'logging', 'tracing'],
    license: 'commercial',
    language: 'Go',
    cloudSupport: ['aws', 'gcp', 'azure'],
  },
  {
    ...
    category: 'monitoring',
    tags: ['observability', 'apm', 'distributed-tracing', 'monitoring', 'opentelemetry'],
    license: 'hybrid',
    language: 'Go',
    cloudSupport: ['aws'],
  },
  ...
  },
  {
    ...
    category: 'ml-inference',
    tags: ['vector-database', 'machine-learning', 'ai', 'embeddings', 'semantic-search', 'llm'],
    license: 'commercial',
    cloudSupport: ['aws', 'gcp'],
  },
  ...
  },
  {
    id: 'retool',
    name: 'Retool',
    description: 'Low-code platform for building internal tools and applications',
    longDescription: 'Retool is a low-code development platform for building web-based internal tools with integrations to any database, API, or service. Self-hosted deployment allows you to run Retool in your own VPC using Docker or Kubernetes.',
    homepage: 'https://retool.com',
    docs: 'https://docs.retool.com/self-hosted',
    category: 'dev-platforms',
    tags: ['low-code', 'internal-tools', 'admin-panels', 'dashboards', 'rapid-development'],
    license: 'commercial',
    cloudSupport: ['aws', 'gcp', 'azure', 'on-prem'],
  },
