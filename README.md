...
- [Restate](https://www.restate.dev/) - Durable execution platform for workflows, AI agents, and microservice orchestration, fully managed in your own cloud and VPC. ([Docs](https://docs.restate.dev/))
